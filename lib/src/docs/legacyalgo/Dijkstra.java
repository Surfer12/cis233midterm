...
/**
 * This class contains a method to perform Dijkstra's algorithm on a graph.
 */
public class Dijkstra {

    /**
     * Performs Dijkstra's algorithm on a graph starting from the given source node.
     * 
     * @param graph The graph represented as an adjacency list.
     * @param source The source node.
     * @return A map containing the shortest distances from the source node to all other nodes.
     * 
